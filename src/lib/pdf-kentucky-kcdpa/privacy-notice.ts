...
export function generatePrivacyNotice(data: ComplianceFormData): jsPDF {
  ...
  y = addWrappedText(
    doc,
    `This Privacy Notice is provided by ${data.company.name} pursuant to KRS Chapter 367 (Kentucky Consumer Data Protection Act, HB 15, effective January 1, 2026). The notice describes the categories of personal data processed, the purposes of processing, and the consumer rights available under the Kentucky KCDPA.`,
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
  ...
  y = addWrappedText(
    doc,
    "KRS Chapter 367 requires controllers to provide a clear and meaningful privacy notice disclosing the categories of personal data processed. Check all categories that apply:",
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
  ...
  y = addWrappedText(
    doc,
    "KRS Chapter 367 requires the notice to describe the purposes for which personal data is processed:",
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
  ...
  y = addSectionHeader(doc, "Consumer Rights Under the Kentucky KCDPA", y);
  y = addWrappedText(
    doc,
    "Under KRS Chapter 367, Kentucky consumers have the following rights. This notice must describe how consumers may exercise them:",
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
  ...
  const rights = [
    "Right to confirm whether personal data is being processed and to access that data (KRS Chapter 367)",
    "Right to correct inaccurate personal data (KRS Chapter 367)",
    "Right to delete personal data (KRS Chapter 367)",
    "Right to data portability \u2014 obtain a copy in a portable, usable format (KRS Chapter 367)",
    "Right to opt out of processing for targeted advertising (KRS Chapter 367)",
    "Right to opt out of sale of personal data (KRS Chapter 367)",
    "Right to opt out of profiling for consequential decisions (KRS Chapter 367)",
  ];
  ...
  y = addWrappedText(
    doc,
    "Per KRS Chapter 367, the controller must respond to authenticated consumer requests within 45 days (extendable by 45 additional days with notice).",
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
