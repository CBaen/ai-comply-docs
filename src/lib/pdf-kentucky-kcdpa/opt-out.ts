...
export function generateOptOutDocumentation(data: ComplianceFormData): jsPDF {
  ...
  y = addWrappedText(
    doc,
    `This document describes ${data.company.name}'s implementation of the opt-out rights available to Kentucky consumers under KRS Chapter 367 (Kentucky Consumer Data Protection Act, HB 15, effective January 1, 2026). Kentucky consumers have the right to opt out of (1) processing for targeted advertising, (2) sale of personal data, and (3) profiling for consequential decisions.`,
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
  ...
  const optOutCategories = [
    "Targeted advertising \u2014 processing personal data to serve ads based on activity across third-party sites (KRS Chapter 367)",
    "Sale of personal data \u2014 exchanging personal data for monetary or other valuable consideration (KRS Chapter 367)",
    "Profiling for consequential decisions \u2014 automated processing affecting financial, employment, healthcare, housing, or educational opportunities (KRS Chapter 367)",
  ];
  ...
  y = addWrappedText(
    doc,
    "The following profiling activities produce consequential effects on consumers and are subject to the opt-out right under KRS Chapter 367. Check all that apply:",
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
