export { generatePrivacyNotice } from "./privacy-notice";
export { generateDataProtectionAssessment } from "./data-protection-assessment";
export { generateConsumerRightsProcedures } from "./consumer-rights-procedures";
export { generateOptOutDocumentation } from "./opt-out";
