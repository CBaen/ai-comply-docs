...
export function generateConsumerRightsProcedures(
  ...
  y = addWrappedText(
    doc,
    `These procedures govern ${data.company.name}'s response to consumer rights requests under IC 24-15 (Indiana Consumer Data Protection Act, effective January 1, 2026). The controller must respond to authenticated consumer requests within 45 days, with the option to extend by an additional 45 days with notice to the consumer.`,
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
  ...
  y = addWrappedText(
    doc,
    "Per IC 24-15, the controller must take reasonable steps to authenticate consumer requests before responding. Recommended Best Practice \u2014 not a statutory mandate: do not require information beyond what is reasonably necessary to verify identity.",
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
  ...
  const rightsAndProcedures = [
    {
      right: "Right to Access (IC 24-15)",
      procedure:
    ...
    {
      right: "Right to Correct (IC 24-15)",
      procedure:
    ...
    {
      right: "Right to Delete (IC 24-15)",
      procedure:
        "Delete personal data concerning the consumer upon request. Apply exceptions under IC 24-15 where applicable (legal obligation, provision of requested service, etc.). Respond within 45 days.",
    },
    {
      right: "Right to Portability (IC 24-15)",
      procedure:
    ...
    {
      right: "Right to Opt Out of Targeted Advertising (IC 24-15)",
      procedure:
  ...
  y = addWrappedText(
    doc,
    "Per IC 24-15, if the controller declines to act on a request, the consumer has the right to appeal. The controller must provide an appeals process and inform the consumer of the outcome and the reasons for the decision. If the appeal is denied, the controller must provide information about how to contact the Indiana Attorney General to submit a complaint.",
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
