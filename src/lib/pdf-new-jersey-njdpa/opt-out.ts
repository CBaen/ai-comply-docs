...
export function generateOptOutDocumentation(data: ComplianceFormData): jsPDF {
  ...
  y = addWrappedText(
    doc,
    `This document describes ${data.company.name}'s implementation of the opt-out rights available to New Jersey consumers under the New Jersey Data Protection Act (S332/A1971, signed January 16, 2024, effective January 15, 2025). New Jersey consumers have the right to opt out of (1) processing for targeted advertising, (2) sale of personal data, and (3) profiling for consequential decisions. Note: The NJDPA is a separate law from the NJ Law Against Discrimination.`,
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
  ...
  const optOutCategories = [
    "Targeted advertising \u2014 processing personal data to serve ads based on activity across third-party sites (NJDPA)",
    "Sale of personal data \u2014 exchanging personal data for monetary or other valuable consideration (NJDPA)",
    "Profiling for consequential decisions \u2014 automated processing affecting financial, employment, healthcare, housing, or educational opportunities (NJDPA)",
  ];
  ...
  y = addWrappedText(
    doc,
    "The following profiling activities produce consequential effects on consumers and are subject to the opt-out right under the NJDPA. Check all that apply:",
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
