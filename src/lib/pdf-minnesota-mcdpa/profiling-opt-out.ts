...
// ============================================================
export function generateProfilingOptOut(data: ComplianceFormData): jsPDF {
  const doc = new jsPDF();
  ...
  y = addWrappedText(
    doc,
    `This document describes ${data.company.name}'s implementation of the opt-out right for profiling in furtherance of decisions that produce legal or similarly significant effects on consumers, as required by Minn. Stat. § 325M.14(a)(5)(iii) (Minnesota Consumer Data Privacy Act, eff. July 31, 2025). "Profiling" under \u00A7 325M.11 means any form of automated processing of personal data to evaluate, analyze, or predict personal aspects concerning an identified or identifiable natural person.`,
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
  ...
  y = addWrappedText(
    doc,
    "The following profiling activities produce legal or similarly significant effects on consumers and are subject to the opt-out right under \u00A7 325M.14(a)(5)(iii). Check all that apply for this organization:",
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
