...
export function generateOptOutDocumentation(data: ComplianceFormData): jsPDF {
  ...
  y = addWrappedText(
    doc,
    `This document describes ${data.company.name}'s implementation of the opt-out rights available to Montana consumers under MCA \u00A7 30-14-2809(1)(e) (Montana Consumer Data Privacy Act, effective October 1, 2024). Montana consumers have the right to opt out of (1) processing for targeted advertising, (2) sale of personal data, and (3) profiling for consequential decisions. Montana has the lowest applicability thresholds of any state privacy law (25,000+ consumers, \u00A7 30-14-2803).`,
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
  ...
  const optOutCategories = [
    "Targeted advertising \u2014 processing personal data to serve ads based on activity across third-party sites (\u00A7 30-14-2809(1)(e)(i))",
    "Sale of personal data \u2014 exchanging personal data for monetary or other valuable consideration (\u00A7 30-14-2809(1)(e)(ii))",
    "Profiling for consequential decisions \u2014 automated processing affecting financial, employment, healthcare, housing, or educational opportunities (\u00A7 30-14-2809(1)(e)(iii))",
  ];
  ...
  y = addWrappedText(
    doc,
    "The following profiling activities produce consequential effects on consumers and are subject to the opt-out right under \u00A7 30-14-2809(1)(e)(iii). Check all that apply:",
    MARGIN,
    y,
    CONTENT_WIDTH,
    LINE_HEIGHT
