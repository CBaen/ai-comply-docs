...
export const regulations: Regulation[] = [
  ...
  },
  {
    slug: "texas-traiga",
    state: "Texas",
    name: "Texas TRAIGA (HB 149) — AI Governance Compliance",
    shortName: "Texas TRAIGA",
    citation: "Tex. Gov't Code Ch. 552 (HB 149, 89th Legislature)",
    citationUrl: "https://capitol.texas.gov/BillLookup/Text.aspx?LegSess=89R&Bill=HB149",
    lawLinkText: "Read HB 149 Enrolled Text on capitol.texas.gov",
    status: "in-effect",
    ...
    maxPenalty: "$80,000–$200,000 per uncurable violation; $2,000–$40,000/day for continuing violations",
    appliesToSummary: "Any person or business that develops or deploys AI systems in Texas or affecting Texas consumers. Applies to all AI systems regardless of risk level — no high-risk carveout. No minimum size, revenue, or employee threshold.",
    appliesToBullets: [
      "You develop, train, or substantially modify AI systems that are used in Texas (you are a 'developer')",
      "OR you use AI systems in products or services offered to Texas consumers or employees (you are a 'deployer')",
      "There is no small-business exemption and no high-risk carveout — any AI system in your Texas operations is in scope",
    ],
    keywords: ["texas", "traiga", "hb149", "hb 149", "ai governance", "nist ai 600-1", "responsible ai", "developer", "deployer"],
    documents: [
  ...
  },
  {
    ...
    penaltySummary: "Oregon Attorney General enforcement (§ 646A.589). No private right of action. Mandatory 30-day cure period expired January 1, 2026 (§ 646A.589(2)); AG now has enforcement discretion and can bring action without prior warning. Civil penalties up to $7,500 per violation (ORS § 646A.589(4)(a)).",
  ...
  },
  {
    ...
    status: "effective-soon",
    effectiveDate: "Annex III high-risk obligations effective August 2, 2026 (Prohibited AI in effect Feb 2025; GPAI in effect Aug 2025)",
    tier: "international",
    category: "AI Governance",
    price: 997,
  ...
  },
  {
    ...
    citationUrl: "https://www.eeoc.gov/laws/guidance/employment-tests-and-selection-procedures",
  ...
  // ═══════════════════════════════════════════
  {
    ...
    appliesToBullets: [
      ...
      "You collect or process health data from children under 13 (COPPA amended rule in effect April 22, 2026)",
    ],
  ...
  },
  {
    ...
    status: "in-effect",
    effectiveDate: "COPPA amended rule in effect April 22, 2026",
    tier: "industry",
    category: "Education",
    price: 397,
  ...
  },
  {
    ...
    documentCount: 3,
    description: "Article 27(1) of the EU AI Act requires specific deployer categories to complete a Fundamental Rights Impact Assessment before first use of a high-risk AI system, covering 6 required elements. The obligation applies to: (1) bodies governed by public law, (2) private entities providing public services, and (3) any deployer of Annex III 5(b) AI (creditworthiness / credit scoring) or Annex III 5(c) AI (life and health insurance risk assessment and pricing). Enforceable from August 2, 2026. This kit provides the FRIA template, authority notification letter, and update trigger assessment.",
    ...
    appliesToSummary: "Per Art. 27(1): (a) bodies governed by public law, (b) private entities providing public services, (c) any deployer of AI used for creditworthiness / credit scoring (Annex III 5(b)), or (d) any deployer of AI used for life or health insurance risk assessment and pricing (Annex III 5(c)). US businesses are in scope under Art. 2(1)(c) if output is used in the EU AND they fit one of these four categories.",
    appliesToBullets: [
