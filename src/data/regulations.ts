...
export const regulations: Regulation[] = [
  ...
  },
  {
    ...
    penaltySummary: "CPPA administrative enforcement and AG civil enforcement. $2,500 per unintentional violation; $7,500 per intentional violation (Cal. Civ. Code § 1798.155). No private right of action for ADMT-specific violations.",
    maxPenalty: "$2,500 per unintentional violation; $7,500 per intentional violation",
    appliesToSummary: "Any business subject to CCPA that uses automated decision-making technology to make significant decisions about California consumers.",
  ...
  },
  {
    ...
    citationUrl: "https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=OJ:L_202401689",
    status: "in-effect",
    effectiveDate: "August 2, 2027 (Annex III deployer obligation — Art. 27)",
    tier: "international",
    category: "Add-On",
    price: 149,
    stripePriceId: "price_1TB7FwGidFVHIL99uFr32JXZ",
    documentCount: 3,
    description: "Article 27 of the EU AI Act requires deployers of certain high-risk AI systems to complete a Fundamental Rights Impact Assessment before first use, covering 6 specific elements. The FRIA obligation applies from August 2, 2027 when Annex III high-risk system requirements take effect. This kit provides the FRIA template, authority notification letter, and update trigger assessment.",
    penaltySummary: "National authorities enforcement. High-risk AI violations: up to €15,000,000 or 3% global turnover (Art. 99(4)). Prohibited AI practices: up to €35,000,000 or 7% global turnover (Art. 99(3)). False information: up to €7,500,000 or 1% global turnover (Art. 99(5)).",
    maxPenalty: "€15M or 3% global turnover (high-risk); €35M or 7% (prohibited)",
