    ...
    return (
      <div className="fixed inset-0 z-[200] flex items-start justify-center overflow-y-auto" role="dialog" aria-modal="true" aria-label="Your documents are ready">
        ...
        <div className="relative bg-white rounded-2xl shadow-2xl max-w-xl w-full mx-4 my-8 sm:my-16 overflow-hidden">
          ...
          <button
            onClick={() => setStatus("idle")}
            className="absolute top-4 right-4 z-10 w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200 text-gray-500 hover:text-gray-700 transition"
            aria-label="Close"
          >
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-4 shadow-sm">
          ...
          >
            ...
            {downloadState === "generating" && "Preparing your package..."}
          {downloadState === "done" && "Package downloaded!"}
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          >
            {sendingEmail && "Generating & Sending..."}
          {!sendingEmail && emailStatus?.type === "success" && "Sent!"}
          {!sendingEmail && emailStatus?.type !== "success" && "Send Documents via Email"}
          </button>
