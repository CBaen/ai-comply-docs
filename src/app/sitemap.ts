...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/illinois-ai-compliance`, lastModified: siteLastUpdated, changeFrequency: "weekly", priority: 0.9 },
    { url: `${base}/california-ai-compliance`, lastModified: siteLastUpdated, changeFrequency: "weekly", priority: 0.9 },
    { url: `${base}/texas-ai-compliance`, lastModified: siteLastUpdated, changeFrequency: "weekly", priority: 0.9 },
