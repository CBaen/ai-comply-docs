...
const REGULATIONS = [
  ...
  { slug: "texas-tdpsa", name: "Texas TDPSA" },
  { slug: "delaware-pdpa", name: "Delaware PDPA" },
  { slug: "multi-state-profiling-assessment", name: "Multi-State Profiling Assessment" },
  { slug: "multi-state-employer-ai-disclosure", name: "Multi-State Employer Disclosure" },
  { slug: "virginia-cdpa", name: "Virginia CDPA" },
  { slug: "connecticut-ctdpa", name: "Connecticut CTDPA" },
  { slug: "oregon-cpa", name: "Oregon CPA" },
  { slug: "manager-ai-training-kit", name: "Manager Training Kit" },
  { slug: "annual-compliance-review", name: "Annual Compliance Review" },
  { slug: "board-ai-summary", name: "Board AI Summary" },
  { slug: "consumer-notice-kit", name: "Consumer Notice Kit" },
  { slug: "data-mapping-inventory", name: "Data Mapping Inventory" },
  { slug: "consumer-rights-kit", name: "Consumer Rights Kit" },
  { slug: "ai-governance-framework", name: "AI Governance Framework" },
  { slug: "ai-system-registry", name: "AI System Registry" },
  { slug: "ai-transparency-report", name: "AI Transparency Report" },
  { slug: "ai-whistleblower-policy", name: "AI Whistleblower Policy" },
  { slug: "customer-ai-aup", name: "Customer AI AUP" },
  { slug: "indiana-icdpa", name: "Indiana ICDPA" },
  { slug: "montana-mcdpa", name: "Montana MCDPA" },
  { slug: "kentucky-kcdpa", name: "Kentucky KCDPA" },
  { slug: "new-jersey-njdpa", name: "New Jersey NJDPA" },
];
