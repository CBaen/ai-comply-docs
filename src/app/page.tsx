          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-red-50 border border-red-100 rounded p-6 border-l-4 border-l-red-400">
                ...
                <h3 className="font-bold text-lg font-display mb-2 text-gray-900">Private Lawsuits</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Employees can file charges or pursue civil actions. Your company pays actual damages and the plaintiff&apos;s attorney fees.
                </p>
              </div>
