...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://aicompliancedocuments.com/products/${reg.slug}`,
    },
    openGraph: {
  ...
  return (
    <>
      ...
      <main id="main-content">
                  ...
                  <ul className="space-y-2.5 mb-4">
                    {reg.appliesToBullets.map((bullet, i) => (
                      <li key={i} className="flex items-start gap-2.5">
                        <svg className="w-5 h-5 text-blue-700 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                  ...
                  >
                    <div className="relative border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition bg-white">
                      ...
                      <div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <span className="bg-white/90 text-gray-700 text-sm font-medium px-4 py-2 rounded-lg shadow">
              ...
              <section className="bg-blue-50 border border-blue-100 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-blue-700 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    <p className="text-sm text-gray-700">Your documents generate instantly as fillable PDFs, packaged in a single zip file.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-blue-700 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" /></svg>
                    <p className="text-sm text-gray-700">Download directly to your device or email to up to 3 team members.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-blue-700 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" /></svg>
                    <p className="text-sm text-gray-700">Fill in the highlighted form fields with your company-specific information. Each document includes clear instructions.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-blue-700 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 013 3m3 0a6 6 0 01-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1121.75 8.25z" /></svg>
                    <p className="text-sm text-gray-700">Sign using the electronic signature blocks — ESIGN Act compliant, no printing required.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm text-gray-700">Have your legal team review the completed documents before deployment.</p>
                  </div>
                </div>
              </section>
        ...
        {/* Related Products — clear visual divider prevents accidental navigation from questionnaire */}
