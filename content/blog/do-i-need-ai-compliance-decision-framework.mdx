...
The NIST AI Risk Management Framework is a voluntary document. No law requires you to follow it. But Colorado SB 24-205 explicitly provides an affirmative defense for businesses that: (1) comply with a nationally or internationally recognized AI risk management framework, and (2) take measures to discover and correct violations of the law — the NIST AI RMF is the most prominent framework that fits that description, though the statute does not name it specifically. ([SB24-205](https://leg.colorado.gov/bills/sb24-205), [NIST AI RMF](https://airc.nist.gov/airmf-resources/airmf/5-sec-core/)) Texas HB 149 takes a different approach: it lists compliance with the NIST "AI Risk Management Framework: Generative AI Profile" as one of the factors a court may consider when determining whether to reduce penalties under Sec. 552.105(e)(D) — it is a penalty-reduction factor, not a compliance benchmark. ([HB 149](https://capitol.texas.gov/BillLookup/History.aspx?LegSess=89R&Bill=HB149))
