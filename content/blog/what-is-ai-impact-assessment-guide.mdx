...
If you're operating across multiple states and want a governance foundation that satisfies the underlying assessment requirements of all enacted state AI laws simultaneously, our [AI Governance Framework](/products/ai-governance-framework) is built around the NIST AI RMF functions — the same framework that triggers Colorado's affirmative defense and that both Colorado and Texas reference as the applicable compliance standard.
