...
## What is an AI bias audit under NYC Local Law 144?

A bias audit under NYC Local Law 144 is an impartial evaluation of an automated employment decision tool (AEDT) that measures whether the tool produces different selection rates for different demographic groups — a concept called disparate impact. The key metric is the impact ratio: a group's selection rate divided by the rate of the most-selected group. A ratio below 0.80 (the federal "four-fifths rule" from the EEOC Uniform Guidelines) signals potential adverse impact requiring attention.
...
## Where does the legal requirement for an annual AI bias audit come from?

The requirement is in NYC Administrative Code § 20-871, enacted as Local Law 144 of 2021 and implemented by NYC DCWP rules at 6 RCNY § 5-301. It makes it unlawful to use an AEDT in employment decisions unless the tool has been audited within the past year, results are publicly posted, and candidates receive advance notice. Enforcement began July 5, 2023.
...
## What does an NYC Local Law 144 bias audit technically require?

Under 6 RCNY § 5-301, the audit must be conducted by a genuinely independent third party (not the vendor or internal team), use historical employment data or — if insufficient — test data with explanation, calculate selection rates and impact ratios for each EEO-1 race/ethnicity and sex category, and produce a public summary including audit date, data source, category counts, selection rates, and impact ratios. The audit is valid for twelve months, then must be repeated.
...
## Which employers need an annual AI bias audit under NYC Local Law 144?

Any employer or employment agency using an AEDT for hiring or promotion decisions involving New York City roles is covered — regardless of where the employer is headquartered. The tool must use machine learning, statistical modeling, data analytics, or AI to produce a score, classification, or recommendation that substantially assists or replaces discretionary decision-making (NYC Admin. Code § 20-870). Employers cannot delegate the audit obligation to their vendor.
...
## What are the penalties for not conducting an annual AI bias audit under NYC Local Law 144?

NYC DCWP can impose up to $500 for a first violation (§ 20-872(a)) and $500–$1,500 per subsequent violation per day. Each use of a non-audited AEDT on each candidate or employee is a potential separate violation — meaning a busy HR department processing hundreds of applications monthly faces compounding daily exposure. DCWP can also require the employer to cease using the tool and mandate corrective action.
...
## What are the limits of an AI bias audit under NYC Local Law 144?

A bias audit does not certify a tool as fair — it measures whether current outcomes show statistically significant disparities across demographic groups. It does not evaluate decision quality (an equally wrong tool for all groups would pass). It does not satisfy Illinois HB3773, EEOC guidelines, or other state notice and oversight requirements. And it is a point-in-time snapshot — if the tool is retrained or updated, the prior audit may no longer reflect current performance, which is why annual audits are required.
...
## How does an employer actually get an NYC Local Law 144 bias audit completed?

If using a major enterprise platform, ask whether the vendor has retained an independent auditor and whether results are available — verify the auditor's independence and that the audit used real employment data within the past year. If the vendor doesn't provide this, retain an independent firm with statistical expertise. Before the audit, prepare a dataset of tool outputs with EEO-1 demographic categories and documentation of how the tool was used in actual decisions.
...
## What notice requirements does NYC Local Law 144 impose beyond the annual bias audit?

Employers must provide written notice to candidates at least ten business days before using an AEDT, identifying that an AEDT will be used, the job qualifications and characteristics the tool will evaluate, and instructions for requesting an alternative process or accommodation (NYC Admin. Code § 20-871). Current employees must receive the same notice at least ten business days in advance. Both notices must include a link to the publicly posted bias audit summary. Notice and audit are separate obligations — satisfying one does not satisfy the other.
...
## What do Illinois HB3773 and federal law add to the AI bias audit requirement beyond NYC?

Illinois HB3773 (775 ILCS 5/2-102(L), effective January 1, 2026) makes it a civil rights violation to use AI that "has the effect of" discriminating based on protected class — and a bias audit is the most direct evidence that a tool is not producing discriminatory effects. The EEOC's 2021 AI initiative confirmed that Title VII, ADEA, and ADA all apply to AI hiring outcomes regardless of vendor responsibility. The federal Uniform Guidelines on Employee Selection Procedures (29 CFR Part 1607) have applied to employment selection systems since 1978 and cover AI tools.
...
## Where is the AI bias audit requirement heading beyond New York City?

NYC remains the only US jurisdiction mandating an annual third-party bias audit by name, but the EU AI Act (Regulation (EU) 2024/1689) requires conformity assessments and ongoing monitoring for AI used in employment beginning August 2, 2026 — a parallel obligation. Enterprise procurement teams are increasingly treating bias audit documentation as a baseline vendor requirement alongside SOC 2 reports, accelerating adoption well beyond jurisdictions where it is legally mandated.
...
## Where should employers start to comply with NYC Local Law 144's bias audit requirement?

First, determine whether your hiring tool qualifies as an AEDT: does it use machine learning, statistical modeling, data analytics, or AI to produce a score, classification, or recommendation used to substantially assist or replace a hiring decision? If yes, verify whether your vendor has a current independent audit, confirm the audit uses real employment data and was done within the past year, check that candidate notices go out at least ten business days before tool use, and confirm the audit summary is posted on your website.
