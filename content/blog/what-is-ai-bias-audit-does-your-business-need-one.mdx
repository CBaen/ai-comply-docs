...
Our [AI Bias Audit Template](/regulations/ai-bias-audit-template) includes the audit summary format, candidate notice templates, and posting checklist required under LL144 — and our [NYC Local Law 144 compliance package](/regulations/nyc-local-law-144) covers the full set of employer obligations from audit through notice requirements.
