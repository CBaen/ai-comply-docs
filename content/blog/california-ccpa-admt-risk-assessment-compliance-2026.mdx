...
**Second**, inventory your AI and automated decision-making. Every tool, every algorithm, every system that processes personal information to make or inform a decision about a consumer needs to be on a list.

**Third**, start your risk assessments. For each processing activity involving profiling, targeted advertising, selling/sharing data, or ADMT, document the purpose, the data involved, the benefits, the risks, and your mitigation measures.

**Fourth**, start planning your ADMT notices. You have until January 2027, but the notice requirements are detailed and getting them right takes time.

You can do all of this with a lawyer at $400-800 an hour, or you can start with compliance document templates that are built from the actual regulation text and fill in the specifics for your business. That's what we do.

---

Ready to start your California risk assessments? Our [CCPA ADMT Compliance Package](/regulations/california-ccpa-admt) includes pre-use notice templates, risk assessment frameworks, opt-out process documentation, and internal policy templates — all built from the [approved regulation text](https://cppa.ca.gov/regulations/pdf/ccpa_updates_cyber_risk_admt_appr_text.pdf).

[Browse Compliance Packages →](/regulations)
