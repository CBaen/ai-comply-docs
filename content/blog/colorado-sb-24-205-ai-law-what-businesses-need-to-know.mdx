...
**Impact assessment.** You need to complete an [impact assessment](/regulations/colorado-sb24-205) for each high-risk system you deploy. The impact assessment evaluates the potential risks of algorithmic discrimination and the steps you're taking to mitigate them.
