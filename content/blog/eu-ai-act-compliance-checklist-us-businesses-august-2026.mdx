...
summary: "The EU AI Act is the world's first comprehensive law regulating artificial intelligence, and it applies to American companies if their AI systems are used in Europe — even if the company has no office there. This article explains the risk categories, what compliance requires for high-risk systems, the penalty structure (up to 7% of global revenue), and the key deadline of August 2, 2026 that US businesses need to plan for now."
cardSummary: "Europe's AI law applies to US companies — even ones with no European office. If your AI is used by anyone in the EU, the deadline is August 2026 and the fines are calculated on your global revenue."
deepDive:
  title: "Extraterritorial Jurisdiction: Why a European Law Is Your Problem"
  content: "Imagine your city passes a building code that says any house sold to a resident of your city must meet certain safety standards — foundation inspections, electrical wiring checks, fire exits. That seems straightforward: build in the city, follow the city's rules. But now imagine the code also says that any house built anywhere in the world, if it is purchased by someone who lives in your city, must also meet those same standards. Suddenly a builder in another state — who has never set foot in your city — has to comply with your city's building code because their product ended up being used by one of your residents.\n\nThat's extraterritorial jurisdiction, and it's how the EU AI Act works. Article 2 of the regulation says the Act applies to providers who place AI systems on the EU market — regardless of where the provider is located — and to providers outside the EU when the output of their AI system is used in the EU. A software company in Austin, Texas that builds an AI hiring tool licensed by a company in Berlin is subject to the EU AI Act. A fintech startup in San Francisco whose credit scoring model is used by a lender serving French customers is subject to the EU AI Act.\n\nThis isn't a new idea. The EU's General Data Protection Regulation (GDPR) pioneered this approach in 2018, and US companies spent billions adapting. The AI Act follows the same logic: EU law protects people in the EU, regardless of where the technology affecting them originates. If you already comply with GDPR because you have European customers, you should assume the AI Act applies to you too.\n\nThe practical consequence is that US companies can't treat EU AI regulation as someone else's problem. If your AI system touches European users, employees, or customers in any of the high-risk categories — employment decisions, credit scoring, insurance, education, law enforcement — the full weight of the regulation applies. And the penalties are calculated as a percentage of global annual turnover, not just EU revenue, which means the EU is penalizing your entire business, not just your European operations."
microFacts:
  ...
  - fact: "The European Commission launched the AI Pact as a voluntary initiative for AI providers and deployers from Europe and beyond to begin complying with key obligations of the AI Act before the mandatory deadlines, signaling that early adoption will be viewed favorably."
    source: "European Commission"
    sourceUrl: "https://digital-strategy.ec.europa.eu/en/policies/ai-pact"
  - fact: "Obligations for providers of general-purpose AI models — including large language models — became applicable on August 2, 2025, making foundation model governance a live regulatory requirement before the high-risk system rules take full effect."
    source: "European Commission"
    sourceUrl: "https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai"
externalReferences:
  ...
  - title: "EU AI Pact — Voluntary Compliance Initiative"
    url: "https://digital-strategy.ec.europa.eu/en/policies/ai-pact"
  - title: "European Commission — Guidelines on Prohibited AI Practices"
  ...
  - title: "European Commission — GPAI Code of Practice"
...
The EU AI Act is [Regulation (EU) 2024/1689](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689), published July 12, 2024 and in force since August 1, 2024 — the world's first comprehensive binding legal framework for AI. It classifies AI systems into four risk tiers (unacceptable, high, limited, and minimal) and attaches proportionate obligations to each. It is enforced by national authorities in each EU member state, with the European AI Office overseeing general-purpose AI models.
...
## Why does the EU AI Act apply to US companies with no European office?

[Article 2 of Regulation (EU) 2024/1689](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689) applies the Act to any provider who places AI systems on the EU market — regardless of where the provider is located — and to any provider or deployer outside the EU when the output of their AI system is used in the EU. A US company licensing AI hiring tools to German companies or using AI to make credit decisions affecting French customers is within scope even without a European office, mirroring the GDPR's extraterritorial logic.
...
## What are the four EU AI Act risk categories, and how do they determine compliance obligations?

[Regulation (EU) 2024/1689, Arts. 5–51](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689) establishes four tiers: unacceptable-risk systems are banned outright (prohibited since February 2, 2025); high-risk systems face the full compliance burden — risk management, technical documentation, logging, human oversight, and conformity assessment; limited-risk systems face transparency obligations; and minimal-risk systems face no mandatory requirements. Where your system lands determines everything you must do.
...
## What does compliance with the EU AI Act's high-risk AI system requirements actually involve?

High-risk AI system compliance under [Arts. 9–25 of Regulation (EU) 2024/1689](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689) requires: a documented risk management system covering the full system lifecycle; data governance practices for training datasets; comprehensive technical documentation per Annex IV; automatic logging of operational events; transparency documentation and user instructions; effective human oversight mechanisms built into the system design; conformity assessment before market placement; an EU declaration of conformity; CE marking; and registration in the EU's public AI database.
...
## What is the EU AI Act compliance timeline, and what is the critical deadline for US businesses?

The Act has staggered applicability dates under [Art. 113 of Regulation (EU) 2024/1689](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689): prohibitions on unacceptable-risk AI took effect February 2, 2025; general-purpose AI model obligations took effect August 2, 2025; and high-risk AI system requirements in Annex III — covering employment AI, credit decisioning, education access, and other common US business applications — become fully enforceable on August 2, 2026. That is the critical deadline for most US businesses operating in EU markets.
...
## What must providers of general-purpose AI models do under the EU AI Act?

[Arts. 53–55 of Regulation (EU) 2024/1689](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689), applicable since August 2, 2025, require GPAI model providers to maintain technical documentation, make it available to downstream providers, adopt a policy complying with EU copyright law, and publish a training data summary. Providers of GPAI models with systemic risk — those trained above 10^25 FLOPs — face additional obligations including adversarial testing, incident reporting to the European AI Office, and energy efficiency reporting.
...
## What are the EU AI Act penalties, and how are they calculated for non-compliant US businesses?

Penalties under [Art. 99 of Regulation (EU) 2024/1689](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689) are calculated on global annual turnover — not just EU revenue. Deploying a prohibited AI system: up to EUR 35 million or 7% of global annual turnover. Violating high-risk system requirements: up to EUR 15 million or 3% of global annual turnover. Supplying misleading information to authorities: up to EUR 7.5 million or 1% of global annual turnover. For a $50 million US company, the 3% tier alone could mean a $1.5 million fine.
...
## What do the EU AI Act's requirements mean in practice for different types of US businesses?

US B2B software companies with European customers using their AI in high-risk contexts are providers who need conformity assessments, technical documentation, CE marking, and EU database registration before August 2, 2026. US companies using AI to manage EU-based employees are deployers with their own obligations — logs, human oversight, instructions compliance. US companies with AI in financial products accessed by EU residents face both provider and deployer requirements. Enterprise procurement teams in Europe are already making compliance a contract requirement.
...
## Where should a US business start to comply with the EU AI Act before the August 2, 2026 deadline?

Start by confirming scope: does your business have any connection to EU markets, EU employees, or EU customers? If yes, inventory every AI system you build or use, then classify each against the four risk tiers — unacceptable (banned), high-risk (Annex III), limited (transparency only), or minimal (no requirements). For each high-risk system, gap-assess against Arts. 9–25, build the missing documentation and processes, complete conformity assessment, and register in the EU database before August 2, 2026.
...
If you're working through the steps above, our [EU AI Act compliance package](/products/eu-ai-act) provides the technical documentation templates, risk management system framework, and conformity assessment records designed specifically for the August 2026 requirements.
