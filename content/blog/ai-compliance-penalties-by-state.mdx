...
If you're operating in multiple states, we've built state-specific compliance documents for each of the major frameworks covered here — including [Illinois HB3773](/regulations/illinois-hb3773), [Colorado SB 24-205](/regulations/colorado-sb24-205), and [California's ADMT rules](/regulations/california-ccpa-admt) — so you don't have to piece together requirements from raw statute text.

---

**Sources** — Every penalty figure in this article was verified against enacted statute text at these URLs:

- [NYC Administrative Code § 20-870 through 20-872 (Local Law 144 of 2021)](https://legistar.council.nyc.gov/LegislationDetail.aspx?ID=4344524&GUID=B051915D-A9AC-451E-81F8-6596032FA3F9) — AEDT bias audit mandate and penalty structure; $375/$1,500 per-violation fines.
